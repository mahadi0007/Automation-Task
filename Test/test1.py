...
class AutomationTest(unittest.TestCase):
    ...
    def test_Automation(self):
        ...
        reg_Page_obj.enter_first_name("Mahadi")
        reg_Page_obj.enter_last_name("Hasan")
        ...
        reg_Page_obj.enter_address("Road 24/2, Dhaka")
        reg_Page_obj.enter_city("New York")
        reg_Page_obj.select_state(5)
        reg_Page_obj.enter_postcode(11217)
        reg_Page_obj.enter_mobile_num(1123456789)
        reg_Page_obj.enter_address_alias("Road 24/2, Dhaka")
        ...
        reg_Page_obj = RegisterPage(driver)
        reg_Page_obj.select_gender()
        reg_Page_obj.enter_first_name("Musfiq")
        reg_Page_obj.enter_last_name("Hasan")
        reg_Page_obj.enter_pass("123456")
